public class lab_2_4 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Switch for byte type:");
        System.out.println(
            switch (byteVariable) 
            {
        ...
        System.out.println("Switch for short type:");
        System.out.println(
        ...
        System.out.println("Switch for int type:");
        System.out.println(
        ...
        System.out.println("Switch for char type:");
        System.out.println(
                switch (charVariable) 
                {
        ...
        System.out.println("Switch for string type:");
        System.out.println(
